...
public class Main extends javax.swing.JFrame {
    ...
    public Main(Connection conn, int userId){
        initComponents();
        this.conn = conn;
        this.userid = userId;
        ...
        form1 = new Form_1(conn,userid);
        form2 = new Form_2(conn,userid);
        form3 = new Form_3(conn,userid);
        ...
        setForm(new Form_2(conn,userid));
    }
